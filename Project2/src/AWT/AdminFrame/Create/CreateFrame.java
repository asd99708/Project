...
public class CreateFrame extends JFrame implements ActionListener,MouseListener {
	private JFrame f;
	private JButton btn1;
	private JLabel la1, la2, la3, la4, la5, la6, la7;
	public TextField tf1 = new TextField(30), tf2 = new TextField(30), tf3 = new TextField(30),
			...
			if (!passMatcher.find()) {
				...
				if (!pnumMatcher.find()) {
					...
					if (!emailMatcher.find()) {
						...
						dao.insertData(new CreateFrameVo(id, password, name, birthdate, pnum, email, addr));
						f.dispose();
